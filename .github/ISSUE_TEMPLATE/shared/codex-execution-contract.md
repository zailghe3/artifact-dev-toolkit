...
This issue is intended to be a self-sufficient implementation contract. Repository-wide engineering and documentation conventions are defined by the applicable `AGENTS.md` files and also apply.
