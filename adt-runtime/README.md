...
- The optional execution timeout is strictly bounded to 5–120 seconds and defaults to 30 seconds for older callers. A control plane requires the `execution-timeout` capability before sending a non-default setting.
