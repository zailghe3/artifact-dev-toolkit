CREATE TABLE workflow_runs (
 ...
 current_step_id TEXT, transition_count INTEGER NOT NULL DEFAULT 0, workflow_instance_id TEXT UNIQUE, workflow_generation INTEGER NOT NULL DEFAULT 1, client_idempotency_key TEXT UNIQUE,
...
CREATE TABLE workflow_step_attempts (
 ...
 input_text TEXT, output_text TEXT, provider_task_id TEXT, provider_state TEXT, provider_poll_count INTEGER NOT NULL DEFAULT 0, started_at TEXT, completed_at TEXT,
