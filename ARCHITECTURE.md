...
- Git definitions contain validated secret-binding references, while credential values remain server-side in Cloudflare bindings or encrypted D1 fallback state.
