/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 41c6c8e6f462d0531a44381747b2e3ce)
// Runtime types generated with workerd@1.20260730.1 2026-07-09 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	ARTIFACT_CATALOGUE_CACHE: KVNamespace;
	AUTH_SESSIONS_DB: D1Database;
	IMAGES: ImagesBinding;
	ASSETS: Fetcher;
	ARTIFACT_REPOSITORY: "github";
	GITHUB_ARTIFACT_REPOSITORY_OWNER: "zailghe3";
	GITHUB_ARTIFACT_REPOSITORY_NAME: "fpo-artifacts";
	CODEX_RUNNER_BASE_URL: string;
	CODEX_RUNNER_ACCESS_CLIENT_ID: string;
	CODEX_RUNNER_ACCESS_CLIENT_SECRET: string;
	CODEX_RUNNER_SHARED_SECRET: string;
	GITHUB_APP_ID: string;
	GITHUB_APP_CLIENT_ID: string;
	GITHUB_APP_CLIENT_SECRET: string;
	GITHUB_APP_PRIVATE_KEY: string;
	GITHUB_TOKEN_ENCRYPTION_KEY: string;
	WORKFLOW_PROVIDER_SECRET_ENCRYPTION_KEY: string;
...
interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ARTIFACT_REPOSITORY" | "GITHUB_ARTIFACT_REPOSITORY_OWNER" | "GITHUB_ARTIFACT_REPOSITORY_NAME" | "GITHUB_APP_ID" | "GITHUB_APP_CLIENT_ID" | "GITHUB_APP_CLIENT_SECRET" | "GITHUB_APP_PRIVATE_KEY" | "GITHUB_TOKEN_ENCRYPTION_KEY" | "SESSION_SECRET" | "CODEX_RUNNER_BASE_URL" | "CODEX_RUNNER_ACCESS_CLIENT_ID" | "CODEX_RUNNER_ACCESS_CLIENT_SECRET" | "CODEX_RUNNER_SHARED_SECRET">> {}
}
