...
export type AdapterInvocation = { runId: string; stepId: string; iteration: number; attempt: number; providerPollCount: number; idempotencyKey: string; agentName: string; masterPrompt: string; inputText: string; tools?: readonly "artifact_search"[]; connection: ResolvedConnection; providerOptions?: unknown };
