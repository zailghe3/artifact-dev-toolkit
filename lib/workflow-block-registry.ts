...
export const publishGitHubPrBlockConfigSchema=z.object({sourceNodeId:z.string().regex(/^[a-z0-9]+(?:-[a-z0-9]+)*$/).max(80),title:z.string().trim().min(1).max(256),body:z.string().max(65536),draft:z.boolean()}).strict();
