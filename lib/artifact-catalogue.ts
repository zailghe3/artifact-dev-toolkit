...
export class ArtifactCatalogueService {
  ...
  private async readSnapshot(): Promise<{ snapshot?: Snapshot; generation?: string; publicationId?: string; failed: boolean }> {
  ...
  private async publish(snapshot: Snapshot, startingGeneration: string | undefined, startingLocalGeneration: number): Promise<CataloguePublicationResult> {
    ...
    catch { return this.recoverCachePublication(snapshot, startingGeneration, publicationId); }
  ...
  private async recoverCachePublication(snapshot: Snapshot, generation: string | undefined, publicationId: string): Promise<CataloguePublicationResult> {
