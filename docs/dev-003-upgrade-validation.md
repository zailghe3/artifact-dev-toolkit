...
- The React hooks lint rules also require the theme toggle to subscribe to document theme changes with `useSyncExternalStore` rather than calling `setState` synchronously from an effect body.
