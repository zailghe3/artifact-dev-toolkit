...
smoke_phase managed-permission
docker run --rm --read-only --cap-drop ALL \
  ...
  --mount "type=bind,src=$script_dir/managed-permission-probe.sh,dst=/run-managed-permission-probe,readonly" \
  "$image" /run-managed-permission-probe \
