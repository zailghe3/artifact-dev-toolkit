...
- Ambient Worker I/O used within a durable Workflow step is resolved in that active step context; orchestration clients do not retain request-context-bound defaults from construction, while explicit test and controlled transports remain supported.
