...
test("auth diagnostic proxy uses the fixed Runner route and validates only bounded fields",async()=>{
 const diagnostic={runnerReachable:true,codexVersion:"0.147.0",codexVersionMatchesExpected:true,codexNativeLibc:"glibc",codexAddressPolicyApplies:true,systemCaBundlePresent:true,systemCaBundleReadable:true,systemCaBundleNonEmpty:true,systemResolverFirstFamily:"ipv4",runnerAddressPolicy:"ipv4_preferred",runnerAddressPolicyEffective:true,kernelIpv6Disabled:false,authOriginHttp1:{protocol:"http1",responseReceived:true,status:403,mitigationChallenge:false,cloudflareEdge:true,redirectPresent:false},deviceAuthHttp1:{protocol:"http1",responseReceived:true,status:405,mitigationChallenge:false,cloudflareEdge:true,redirectPresent:false},deviceAuthHttp2:{protocol:"http2",responseReceived:true,status:405,mitigationChallenge:false,cloudflareEdge:true,redirectPresent:false},deviceAuthNamedClientHttp1:{protocol:"http1",responseReceived:true,status:405,mitigationChallenge:false,cloudflareEdge:true,redirectPresent:false},clientIdentificationChangesOutcome:false,codexAuthTransportProbeStatus:"ok",codexAuthTransportProbe:{baseline:{outcome:"http_response",status:400,protocol:"http1",cloudflareEdge:true,mitigationChallenge:false,contentKind:"json"},validJsonEmptyClient:{outcome:"http_response",status:400,protocol:"http1",cloudflareEdge:true,mitigationChallenge:false,contentKind:"json"}},summary:[], codexAppServerReady:true,customCaSource:"codex_ca_certificate",customCaFileReadable:false,httpProxyConfigured:true,httpsProxyConfigured:false,allProxyConfigured:false,noProxyConfigured:true,dnsResolution:"ok",ipv4Available:true,ipv6Available:false,ipv4TcpConnectivity:"ok",ipv6TcpConnectivity:"unavailable",ipv4TlsConnectivity:"ok",ipv6TlsConnectivity:"unavailable",httpsResponseReceived:true,httpsStatus:403,httpsMitigationChallenge:false,tcpConnectivity:"timeout",codexHomeReadable:true,codexHomeWritable:false};let request;
 ...
 const legacy={...diagnostic};delete legacy.systemCaBundlePresent;delete legacy.systemCaBundleReadable;delete legacy.systemCaBundleNonEmpty;delete legacy.codexNativeLibc;delete legacy.codexAddressPolicyApplies;delete legacy.codexAuthTransportProbeStatus;delete legacy.codexAuthTransportProbe;assert.deepEqual(await new CodexRunnerClient(configuration,async()=>Response.json(legacy)).authEnvironmentDiagnostics(),legacy);
...
test("auth diagnostic proxy rejects malformed and oversized Runner responses",async()=>{
 const valid={runnerReachable:true,codexVersion:"0.147.0",codexVersionMatchesExpected:true,codexNativeLibc:"glibc",codexAddressPolicyApplies:true,systemResolverFirstFamily:"ipv4",runnerAddressPolicy:"ipv4_preferred",runnerAddressPolicyEffective:true,kernelIpv6Disabled:false,authOriginHttp1:{protocol:"http1",responseReceived:true,status:403,mitigationChallenge:false,cloudflareEdge:true,redirectPresent:false},deviceAuthHttp1:{protocol:"http1",responseReceived:true,status:405,mitigationChallenge:false,cloudflareEdge:true,redirectPresent:false},deviceAuthHttp2:{protocol:"http2",responseReceived:true,status:405,mitigationChallenge:false,cloudflareEdge:true,redirectPresent:false},deviceAuthNamedClientHttp1:{protocol:"http1",responseReceived:true,status:405,mitigationChallenge:false,cloudflareEdge:true,redirectPresent:false},clientIdentificationChangesOutcome:false,codexAuthTransportProbeStatus:"ok",codexAuthTransportProbe:{baseline:{outcome:"http_response",status:400,protocol:"http1",cloudflareEdge:true,mitigationChallenge:false,contentKind:"json"},validJsonEmptyClient:{outcome:"http_response",status:400,protocol:"http1",cloudflareEdge:true,mitigationChallenge:false,contentKind:"json"}},summary:[], codexAppServerReady:true,customCaSource:"none",httpProxyConfigured:false,httpsProxyConfigured:false,allProxyConfigured:false,noProxyConfigured:false,dnsResolution:"ok",ipv4Available:true,ipv6Available:false,ipv4TcpConnectivity:"ok",ipv6TcpConnectivity:"unavailable",ipv4TlsConnectivity:"ok",ipv6TlsConnectivity:"unavailable",httpsResponseReceived:true,httpsStatus:403,httpsMitigationChallenge:false,tcpConnectivity:"ok",codexHomeReadable:true,codexHomeWritable:true};
 for(const value of [{...valid,customCaSource:"/secret/ca"},{...valid,customCaFileReadable:true},{...valid,dnsResolution:"192.0.2.1"},{...valid,tcpConnectivity:"socket-error-sentinel"},{...valid,codexNativeLibc:"gnu"},{...valid,codexAddressPolicyApplies:"yes"},{...valid,codexAuthTransportProbeStatus:"invalid_json"},{...valid,codexAuthTransportProbeStatus:"ok",codexAuthTransportProbe:undefined},{...valid,codexAuthTransportProbeStatus:"raw error"}])await assert.rejects(new CodexRunnerClient(configuration,async()=>Response.json(value)).authEnvironmentDiagnostics(),error=>error.category==="invalid_response");
