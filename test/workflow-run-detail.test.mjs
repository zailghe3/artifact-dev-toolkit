...
async function database() {
  ...
  for (const migration of ['0003_create_workflow_runs.sql', '0007_add_provider_transport_diagnostics.sql','0008_add_provider_transport_reason.sql','0010_add_workflow_run_repository_context.sql','0012_add_graph_activation_identity.sql','0014_add_workflow_composition_snapshot.sql','0015_add_workflow_orchestration_diagnostics.sql','0017_add_managed_code_repository_contexts.sql']) {
